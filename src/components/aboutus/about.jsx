  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <img src="/path/to/image1.jpg" alt="About Us 1" style={{ width: '100px', height: '100px', marginRight: '20px' }} />
        <div>
      ...
      {/* Second row */}
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <img src="/path/to/image2.jpg" alt="About Us 2" style={{ width: '100px', height: '100px', marginRight: '20px' }} />
        <div>
      ...
      {/* Third row */}
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <img src="/path/to/image3.jpg" alt="About Us 3" style={{ width: '100px', height: '100px', marginRight: '20px' }} />
        <div>
